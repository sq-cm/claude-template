...
| **Cross-modal bridge prompt** | A versioned prompt designed to translate outputs from one modality into well-formed inputs for the next model in the chain | Git-tracked prompt file with changelog |
