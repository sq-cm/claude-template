...
## Scope & success
(in/out of scope, success condition, deadline if any)

## Structure
(note only if this project deviates from the standard 01 Briefs / 02 Working / 03 Deliverables layout — otherwise leave blank)

## Owners
(PM, persona owner(s), client contact if relevant)
