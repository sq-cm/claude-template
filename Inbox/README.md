...
Staging area for incoming material before it's routed, filed, or actioned.
...
| Folder | Purpose |
|---|---|
| `Personal/` | Notes, reference material, or requests from the user — not yet routed to team |
| `Team/` | Inbound files or context passed between team members mid-task |
