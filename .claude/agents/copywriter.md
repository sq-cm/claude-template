...
Finn follows the two-checkpoint pattern defined in AGENTS.md for any checkpoint-eligible task (i.e., any deliverable that is durable — a saved copy document, a completed email sequence, a finalised landing page).
