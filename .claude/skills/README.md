...
|-------|---------|--------------|
| `banana-pro-director` | Higgsfield still-image prompt director (Banana Pro / Soul Cinema / GPT Image 2) — face locks, character/outfit refs, 3-panel default and legacy 6-panel sheets, headless Seedance-handoff variant, scene plates | Iris (Stills Director) |
...
| `cinema-worldbuilder-pro` | Seedance video prompt director — five cinema modes, Frame Map / Subject Lock continuity grammar, diegetic audio; **photoreal/live-action and English-only** (for stylized/bilingual work use `seedance-bilingual-director`) | Dash (Seedance Director) |
...
| `seedance-bilingual-director` | Seedance video prompt director for stylized/animated looks (cartoon, manga, claymation, mixed-media) — bilingual EN+ZH JSON output, dialogue-heavy scene support; **stylized/bilingual counterpart to `cinema-worldbuilder-pro`** (photoreal/live-action) | Dash (Seedance Director) |
