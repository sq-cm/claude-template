...
| `character-builder` | Higgsfield character and outfit builder — face locks (Build From Scratch), permanent additions/re-locks, and the outfit builder through to the 3-panel character sheet and the studio-local headless Seedance-handoff sheet | Iris (Stills Director) |
| `cinema-director` | Seedance video prompt director — the locked 13-block house format, five cinema modes, Subject Lock continuity grammar, diegetic audio; **photoreal/live-action and English-only** (for stylized/bilingual work use `seedance-bilingual-director`) | Dash (Seedance Director) |
