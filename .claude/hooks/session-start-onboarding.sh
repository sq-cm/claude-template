...
REQUIRED_KEYS="tier1_git_hooks tier1_env_copy tier1_node tier2_caveman tier2_plugin_claude_mem tier2_plugin_context_mode tier2_plugin_obsidian tier2_plugin_superpowers tier2_plugin_marketing_skills tier2_plugin_document_skills tier2_plugin_skill_creator tier2_plugin_frontend_design tier2_plugin_plannotator tier2_plugin_higgsfield tier2_vscode_git"
...
Flag→step map: tier1_git_hooks/tier1_env_copy = hook already ran (set true unless FAILED); tier1_node = set true iff Node present; tier2_plugin_claude_mem/context_mode/obsidian/superpowers/marketing_skills/document_skills/skill_creator/frontend_design/plannotator/higgsfield = Step 8+9 plugin pairs (plannotator's binary install is a separate optional Step 10 — do not auto-run it; the plugin registration flag here covers only the Claude Code plugin, which auto-installs per settings.json); tier2_caveman = Step 7 + '/caveman lite'; tier2_vscode_git = Step 3."
