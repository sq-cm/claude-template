...
REQUIRED_KEYS="tier1_git_hooks tier1_env_copy tier1_node tier2_caveman tier2_plugin_claude_mem tier2_plugin_context_mode tier2_plugin_obsidian tier2_plugin_superpowers tier2_plugin_impeccable tier2_plugin_marketing_skills tier2_plugin_document_skills tier2_plugin_skill_creator tier2_plugin_frontend_design tier2_plugin_plannotator tier2_plugin_higgsfield tier2_vscode_git"
...
if [ -d "$PLUGINS_DIR" ] && command -v find >/dev/null 2>&1; then
  for p in claude-mem context-mode obsidian superpowers impeccable marketing-skills document-skills skill-creator frontend-design plannotator higgsfield caveman; do
