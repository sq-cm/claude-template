...
- How to move a finished file from 02 Working/ to 03 Deliverables/
- The Project Manager's role tracking task status

## What's already done
- Client brief (01 Briefs/)
- Technical SEO section of the audit
- On-Page SEO section of the audit
- Score table (partially filled)

## What you need to complete
1. Open `02 Working/seo-audit-draft.md`
...
5. Move the finished report to `03 Deliverables/SEO Audit Report — Bloom Bakery.md`
