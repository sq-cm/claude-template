...
> Do not move this file to `03 Deliverables/` until Checkpoint B is complete and logged.

---

## Headlines 1–3 *(complete)*

---

**Option 1**
> **Headline:** Taste what Tasmania grows.
> **Subheadline:** Single-origin beans, roasted small, shipped direct from Hobart.

*Finn's note: Leads with place. Works for home brewers who care about provenance. Might not grab café buyers.*

---

**Option 2**
> **Headline:** The cup knows if you cut corners.
> **Subheadline:** We don't. Thornwood roasts to the bean, not the batch size.

*Finn's note: More direct, speaks to quality without saying "quality." Dry tone matches brand. Strong for both audiences.*
