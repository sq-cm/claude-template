# Checkpoint Log — Thornwood Coffee Brand Copy

This file records all @{SeniorAdviser} advisor checkpoints for this project. Each entry must be logged before and after consulting @{SeniorAdviser}.

---

## How to invoke @{SeniorAdviser}
...
Agent(
  ...
  prompt: "You are @{SeniorAdviser} — Senior Adviser (see .claude/agents/senior-adviser.md).
...
**@{SeniorAdviser}'s response:**
> 1. Anchor each headline to the drinker's experience or outcome — not the brand's process. The brand earns presence by implication.
...
**@{SeniorAdviser}'s response:**
*(Paste @{SeniorAdviser}'s response here)*

**Applied:**
*(List any changes made based on @{SeniorAdviser}'s advice)*

---

*Add further entries below as needed.*
