...
**{SeedanceDirector} Dash** — `seedance-director.md`. Seedance video prompt direction with geometry mapping and asset identity locking. Add alongside Marlowe and Iris. Skip if you don't produce Seedance video.
