...
| `ai-cinema-skills` (Joey / AI Cinema) | **Not a git repo** — a YouTube-channel skill drop, distributed as downloadable skill folders in the video description. Upstream for `cinema-director`, `character-builder`, `banana-pro-director` and `story-bible-builder`. Three drops adopted: 3.0 (14/07/2026, PR #197), drop 2 (04/08/2026, PR #260/#261), drop 3 (19/08/2026). Consult the local snapshot, not a clone — there is nothing to `git pull`. | `skills, image-gen` | No repo — YouTube channel; drop-3 source video https://www.youtube.com/watch?v=5dWgZDka3Ww · local snapshot `Notes/Team/Joey's Skill Files 081626/` |
