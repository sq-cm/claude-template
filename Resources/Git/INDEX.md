...
| `blader/humanizer` | AI-writing-pattern removal skill based on Wikipedia's "Signs of AI writing". Reference-only, no local clone — upstream for the vendored humaniser skill; base-flipped to v2.11.1 on 19/08/2026. | `skills, content` | https://github.com/blader/humanizer |
