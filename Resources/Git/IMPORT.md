# IMPORT.md — Repo import queue

Drop GitHub URLs here, one per line, then run `/import-repos`.
Blank lines and lines starting with `#` are ignored.
This file is cleared automatically after each import run.
...
https://github.com/kkoppenhaver/cc-nano-banana
https://github.com/kkoppenhaver/cc-skills
https://github.com/anthropics/claude-code
https://github.com/shanraisshan/claude-code-best-practice
https://github.com/forrestchang/andrej-karpathy-skills
https://github.com/jshchnz/claude-code-image
...
https://github.com/AgriciDaniel/claude-prompts
