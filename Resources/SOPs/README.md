...
| [`Roster Drift SOP.md`](Roster%20Drift%20SOP.md)               | Pre-hire/fire/swap checklist to keep AGENTS.md, .claude/agents/, and theme-name-map.md in sync               |
...
| [`Folder-Tier CLAUDE.md SOP.md`](Folder-Tier%20CLAUDE.md%20SOP.md) | Lazy-loaded folder-level AGENTS.md files — placement test, verified load semantics, canonical folder list, Orchestrator-only governance, QA carve-out |
...
SOPs are referenced directly from `AGENTS.md`. Changes should be routed through @{Orchestrator} — edits affect team-wide behaviour and need to stay consistent with AGENTS.md.

## Adding a new SOP

1. Draft the SOP as a new `.md` file in this folder
2. Link it from the relevant section in `AGENTS.md`
