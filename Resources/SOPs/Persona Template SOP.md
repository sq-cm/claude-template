...
| Judgement | `claude-opus-5` | Judgement-heavy production personas elevated above the Production default without gatekeeping authority. Currently: HR Lead, Senior Researcher, Copywriter, Business Analyst, Brand Strategist, Legal and Compliance Writer. Near-Fable capability at half the price (Opus 5, released 24/07/2026); revert target `claude-sonnet-5`. A flagged Opus 5 request auto-falls-back to `claude-opus-4-8` in Claude Code — surfaced to the Orchestrator as a blocker, never a silent drop. |
...
A top-tier promotion may elevate a decided set of judgement-heavy production personas above the `claude-sonnet-5` Production default. Currently elevated to `claude-opus-5` (Judgement tier): HR Lead, Senior Researcher, Copywriter, Business Analyst, Brand Strategist, Legal and Compliance Writer. Any such promotion records its revert target (`claude-sonnet-5`) in each promoted persona's in-file model note — that note is the durable signal. `claude-opus-4-8` is retired from the roster (25/07/2026). The dispatch-time fallback for gatekeeper Fable 5 refusals is `claude-opus-5` (released 24/07/2026, superseding Opus 4.8 at the same price) — in that fallback role it is a dispatch override on the gatekeeper, not a change to the gatekeeper's frontmatter pin.
