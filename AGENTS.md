...
- **Meta requests** (roster, archive, AGENTS.md or CLAUDE.md edits, conflict resolution): handle directly — see Orchestrator-Only Operations.
...
- Editing any AGENTS.md or CLAUDE.md file — root or folder-tier ([Folder-Tier CLAUDE.md SOP](Resources/SOPs/Folder-Tier%20CLAUDE.md%20SOP.md))
...
Governance-artefact edits — any AGENTS.md or CLAUDE.md, SOP, or persona file — stay checkpoint-eligible even though the Orchestrator executes them itself; being Orchestrator-only never exempts an edit from Checkpoints A and B.
...
Folder purposes, permitted root-level files (`AGENTS.md`, `CLAUDE.md`, `README.md`, `CHANGELOG.md`, installers, `.env*`), and carve-out rationale: see [Vault/README.md](Vault/README.md) § Root-level layout.
